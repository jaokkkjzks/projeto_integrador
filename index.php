            ...
            <div class="card card-body">
                <form action="index.php" method="post">
                    ...
                    <div class="from-group">
                        <textarea name="descricao" class="form-control" id="" cols="30" rows="10" placeholder="Descrição"></textarea>
    ...
    while ($linha = mysqli_fetch_assoc($resultados)) { ?>
        <tr>
            ...
            <td>
                ...
                <a href="excluir.php?id=<?= $linha['id'] ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
            </td>
        </tr>
